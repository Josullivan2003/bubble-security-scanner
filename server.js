  ...
  try {
    ...
    const message = await anthropic.messages.create({
      ...
      messages: [
        {
          role: 'user',
          content: `You are a security expert. Analyze this list of exposed sensitive data and select the TOP 3-4 most critical tables to flag.

Exposed data found:
${dataDescription}

PRIORITIZATION ORDER (highest to lowest risk):
